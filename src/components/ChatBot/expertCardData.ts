...
export const userExpertCards: ExpertCard[] = [
  ...
  // {id: 'education', title: '교육 전문가', expert_type: '장애인 교육', description: '장애인 교육 프로그램 및 지원 제도 안내', icon: '📚'},
  // {id: 'counseling', title: '상담 전문가', expert_type: '전문 상담', description: '장애인 심리 상담 및 가족 상담 프로그램', icon: '💬'}
];
