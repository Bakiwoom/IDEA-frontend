...
export const USER_MYPAGE_MAIN = '/user/mypage/userMyPageMain';
export const CATEGORY_PAGE = '/user/categoryListPage';
export const EDIT_PAGE = '/user/mypage/userEditPage';